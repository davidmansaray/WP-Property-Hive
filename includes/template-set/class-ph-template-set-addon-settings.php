				...
				'controls'        => array(
					'data_source' => array(
						...
						'options'    => array(
							...
							'manual'    => __( 'Manage locations manually', 'propertyhive' ),
						),
			...
			array(
				...
				'controls'        => array(
					'positions' => array(
						...
						'default'    => '5',
						'placeholder' => __( 'e.g. 5, 10, 15', 'propertyhive' ),
						'help'       => __( 'Separate multiple result numbers with commas.', 'propertyhive' ),
					),
				),
			),
			array(
			...
			array(
				...
				'controls'          => array(
					'available_days' => array(
						'type'       => 'multiselect',
						'label'      => __( 'Available viewing days', 'propertyhive' ),
						'options'    => self::get_viewing_request_day_options(),
						'option_key' => 'available_days',
						'default'   => array(),
						'help'      => __( 'Select all days that apply.', 'propertyhive' ),
					),
					'viewing_time_from' => array(
						'type'       => 'select',
						'label'      => __( 'Earliest viewing time', 'propertyhive' ),
					...
					'viewing_time_to' => array(
						'type'       => 'select',
						'label'      => __( 'Latest viewing time', 'propertyhive' ),
						'options'    => $viewing_time_options,
